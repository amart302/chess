class Piece {
  ...
  getSymbol() {
    const symbols = {
      pawn: { white: "./images/whiteShapes/pawn.svg", black: "./images/blackShapes/pawn.svg" },
      rook: { white: "./images/whiteShapes/rook.svg", black: "./images/blackShapes/rook.svg" },
      knight: { white: "./images/whiteShapes/horse.svg", black: "./images/blackShapes/horse.svg" },
      bishop: { white: "./images/whiteShapes/officer.svg", black: "./images/blackShapes/officer.svg" },
      queen: { white: "./images/whiteShapes/queen.svg", black: "./images/blackShapes/queen.svg" },
      king: { white: "./images/whiteShapes/king.svg", black: "./images/blackShapes/king.svg" },
    };
    ...
    for (let y = 0; y < 8; y++) {
      for (let x = 0; x < 8; x++) {
        ...
        if (piece) {
          ...
          pieceDiv.innerHTML = `<img src="${piece.getSymbol()}" />`;
